...
Abstract classes and interfaces have different use cases. Try to baseFigure out when to use 
...
#### You can pass random values to the constructor of a baseFigure instead of generating them inside baseFigure classes.
...
public class FigureSupplier {
    ...
    public Figure getRandomFigure() {
        ...
        // generate a specific baseFigure based on the `figureNumber` value
    }
}
```
* Improved example:
...
#### Creating a baseFigure, don't pass expressions in the constructor. 
